...
```groovy
 dependencies {
     ...
     implementation 'com.github.kinfoundation.kin-ecosystem-android-sdk:sdk:0.2.0'
...
* [Adding Native Offers to Marketplace Offer Wall](docs/ADD_NATIVE_OFFERS_TO_MARKETPLACE.md)
