...
public class SpendOrderCreationReceived implements Event {
    ...
    // Augmented by script
    public static SpendOrderCreationReceived create(String offerId, String orderId, Boolean isNative, SpendOrderCreationReceived.Origin origin) {
     ...
     * @param isNative
     */
    public SpendOrderCreationReceived(Common common, User user, Client client, String offerId, String orderId, Boolean isNative, SpendOrderCreationReceived.Origin origin) {
        super();
        this.common = common;
        this.user = user;
        this.client = client;
