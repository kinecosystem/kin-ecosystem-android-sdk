...
class EventsApi {
     ...
     */
    public Call sendEventCall(Object event) throws ApiException {
        ...
        localVarHeaderParams.put("X-REQUEST-ID", apiClient.parameterToString(getUniqueID()));
    ...
    private Call sendEventValidateBeforeCall(Object event) throws ApiException {
     ...
     */
    public Call sendEventAsync(Object event, final ApiCallback<String> callback)
        throws ApiException {
