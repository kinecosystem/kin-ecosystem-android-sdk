 ...
 * 
 */
public class EarnCompletedPageViewed {
    // Augmented by script
    public static EarnCompletedPageViewed create(EarnCompletedPageViewed.OfferType offerType, Double kinAmount, String offerId, String orderId) {
        return new EarnCompletedPageViewed(EventName.EARN_COMPLETED_PAGE_VIEWED, Store.common, Store.user, offerType, kinAmount, offerId, orderId);
    }
