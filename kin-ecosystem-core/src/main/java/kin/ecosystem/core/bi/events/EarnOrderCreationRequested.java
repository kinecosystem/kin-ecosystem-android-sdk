 ...
 * 
 */
public class EarnOrderCreationRequested {
    // Augmented by script
    public static EarnOrderCreationRequested create(EarnOrderCreationRequested.OfferType offerType, Double kinAmount, String offerId, String orderId) {
        return new EarnOrderCreationRequested(EventName.EARN_ORDER_CREATION_REQUESTED, Store.common, Store.user, offerType, kinAmount, offerId, orderId);
    }
