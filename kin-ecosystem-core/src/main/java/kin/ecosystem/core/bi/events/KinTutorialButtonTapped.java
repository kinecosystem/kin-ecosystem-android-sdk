 ...
 * 
 */
public class KinTutorialButtonTapped {
    // Augmented by script
    public static KinTutorialButtonTapped create(Integer tutorialStep, KinTutorialButtonTapped.OfferType offerType, String offerId, String orderId) {
        return new KinTutorialButtonTapped(EventName.KIN_TUTORIAL_BUTTON_TAPPED, Store.common, Store.user, tutorialStep, offerType, offerId, orderId);
    }
