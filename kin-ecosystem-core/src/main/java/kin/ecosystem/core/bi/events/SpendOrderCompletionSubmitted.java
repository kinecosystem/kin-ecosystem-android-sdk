 ...
 * 
 */
public class SpendOrderCompletionSubmitted {
    // Augmented by script
    public static SpendOrderCompletionSubmitted create(String offerId, String orderId) {
        return new SpendOrderCompletionSubmitted(EventName.SPEND_ORDER_COMPLETION_SUBMITTED, Store.common, Store.user, offerId, orderId);
    }
