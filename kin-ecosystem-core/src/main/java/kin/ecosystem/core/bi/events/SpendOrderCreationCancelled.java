 ...
 * 
 */
public class SpendOrderCreationCancelled {
    // Augmented by script
    public static SpendOrderCreationCancelled create(String offerId, String orderId) {
        return new SpendOrderCreationCancelled(EventName.SPEND_ORDER_CREATION_CANCELLED, Store.common, Store.user, offerId, orderId);
    }
