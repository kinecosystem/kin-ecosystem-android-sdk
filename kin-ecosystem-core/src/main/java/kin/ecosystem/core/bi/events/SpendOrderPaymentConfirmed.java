 ...
 * 
 */
public class SpendOrderPaymentConfirmed {
    // Augmented by script
    public static SpendOrderPaymentConfirmed create(String transactionId, String offerId, String orderId) {
        return new SpendOrderPaymentConfirmed(EventName.SPEND_ORDER_PAYMENT_CONFIRMED, Store.common, Store.user, transactionId, offerId, orderId);
    }
