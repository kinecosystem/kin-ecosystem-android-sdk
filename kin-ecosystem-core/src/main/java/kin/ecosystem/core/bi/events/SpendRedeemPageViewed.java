 ...
 * 
 */
public class SpendRedeemPageViewed {
    // Augmented by script
    public static SpendRedeemPageViewed create(SpendRedeemPageViewed.RedeemTrigger redeemTrigger, Double kinAmount, String offerId, String orderId) {
        return new SpendRedeemPageViewed(EventName.SPEND_REDEEM_PAGE_VIEWED, Store.common, Store.user, redeemTrigger, kinAmount, offerId, orderId);
    }
