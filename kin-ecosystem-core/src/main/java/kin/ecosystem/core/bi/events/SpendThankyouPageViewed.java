 ...
 * 
 */
public class SpendThankyouPageViewed {
    // Augmented by script
    public static SpendThankyouPageViewed create(Double kinAmount, String offerId, String orderId) {
        return new SpendThankyouPageViewed(EventName.SPEND_THANKYOU_PAGE_VIEWED, Store.common, Store.user, kinAmount, offerId, orderId);
    }
