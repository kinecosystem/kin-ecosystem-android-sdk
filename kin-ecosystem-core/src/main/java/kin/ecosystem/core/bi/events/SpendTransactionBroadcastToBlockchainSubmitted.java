 ...
 * 
 */
public class SpendTransactionBroadcastToBlockchainSubmitted {
    // Augmented by script
    public static SpendTransactionBroadcastToBlockchainSubmitted create(String offerId, String orderId) {
        return new SpendTransactionBroadcastToBlockchainSubmitted(EventName.SPEND_TRANSACTION_BROADCAST_TO_BLOCKCHAIN_SUBMITTED, Store.common, Store.user, offerId, orderId);
    }
