...
public class StellarAccountCreationFailed implements Event {
    ...
    public static StellarAccountCreationFailed create(String errorReason) {
        return new StellarAccountCreationFailed(
            EventName.STELLAR_ACCOUNT_CREATION_FAILED,
    ...
    public static void fire(String errorReason) {
        final StellarAccountCreationFailed event = new StellarAccountCreationFailed(
            EventName.STELLAR_ACCOUNT_CREATION_FAILED,
            (Common) EventsStore.common(),
            (User) EventsStore.user(),
            errorReason);
