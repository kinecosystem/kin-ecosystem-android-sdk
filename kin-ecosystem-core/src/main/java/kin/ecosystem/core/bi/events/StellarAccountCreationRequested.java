 ...
 * 
 */
public class StellarAccountCreationRequested {
    // Augmented by script
    public static StellarAccountCreationRequested create() {
        return new StellarAccountCreationRequested(EventName.STELLAR_ACCOUNT_CREATION_REQUESTED, Store.common, Store.user);
    }
