 ...
 * 
 */
public class StellarAccountCreationSucceeded {
    // Augmented by script
    public static StellarAccountCreationSucceeded create() {
        return new StellarAccountCreationSucceeded(EventName.STELLAR_ACCOUNT_CREATION_SUCCEEDED, Store.common, Store.user);
    }
