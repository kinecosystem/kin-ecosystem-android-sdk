 ...
 * 
 */
public class StellarKinTrustlineSetupSucceeded {
    // Augmented by script
    public static StellarKinTrustlineSetupSucceeded create() {
        return new StellarKinTrustlineSetupSucceeded(EventName.STELLAR_KIN_TRUSTLINE_SETUP_SUCCEEDED, Store.common, Store.user);
    }
