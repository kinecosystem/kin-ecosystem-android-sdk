 ...
 * 
 */
public class EarnTransactionBroadcastToBlockchainSucceeded implements Event {
    // Augmented by script
    public static EarnTransactionBroadcastToBlockchainSucceeded create(String transactionId, String offerId, String orderId) {
        return new EarnTransactionBroadcastToBlockchainSucceeded(
            EventName.EARN_TRANSACTION_BROADCAST_TO_BLOCKCHAIN_SUCCEEDED,
    ...
    public static void fire(String transactionId, String offerId, String orderId) {
        final EarnTransactionBroadcastToBlockchainSucceeded event = new EarnTransactionBroadcastToBlockchainSucceeded(
            EventName.EARN_TRANSACTION_BROADCAST_TO_BLOCKCHAIN_SUCCEEDED,
            (Common) EventsStore.common(),
            (User) EventsStore.user(),
            transactionId,
