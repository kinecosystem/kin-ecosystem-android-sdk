...
public class BackButtonOnWelcomeScreenPageTapped implements Event {
    public static final String EVENT_NAME = "back_button_on_welcome_screen_page_tapped";
    public static final String EVENT_TYPE = "analytics";

    // Augmented by script
    public static BackButtonOnWelcomeScreenPageTapped create() {
        return new BackButtonOnWelcomeScreenPageTapped(
     ...
     * @param user
     */
    public BackButtonOnWelcomeScreenPageTapped(Common common, User user, Client client) {
        super();
        this.common = common;
        this.user = user;
        this.client = client;
