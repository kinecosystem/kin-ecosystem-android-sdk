...
public class EarnCompletedPageViewed implements Event {
     ...
     * @param user
     */
    public EarnCompletedPageViewed(Common common, User user, Client client, EarnCompletedPageViewed.OfferType offerType, Double kinAmount, String offerId, String orderId) {
        super();
        this.common = common;
        this.user = user;
        this.client = client;
