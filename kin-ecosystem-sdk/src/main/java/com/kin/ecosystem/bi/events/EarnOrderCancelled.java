...
public class EarnOrderCancelled implements Event {
    public static final String EVENT_NAME = "earn_order_cancelled";
     ...
     * @param user
     */
    public EarnOrderCancelled(Common common, User user, Client client, String offerId, String orderId) {
        super();
        this.common = common;
        this.user = user;
        this.client = client;
