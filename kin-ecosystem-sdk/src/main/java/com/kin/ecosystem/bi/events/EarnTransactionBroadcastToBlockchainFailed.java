...
public class EarnTransactionBroadcastToBlockchainFailed implements Event {
    ...
    public static EarnTransactionBroadcastToBlockchainFailed create(String errorReason, String offerId, String orderId) {
        return new EarnTransactionBroadcastToBlockchainFailed(
            EventName.EARN_TRANSACTION_BROADCAST_TO_BLOCKCHAIN_FAILED,
    ...
    public static void fire(String errorReason, String offerId, String orderId) {
        final EarnTransactionBroadcastToBlockchainFailed event = new EarnTransactionBroadcastToBlockchainFailed(
            EventName.EARN_TRANSACTION_BROADCAST_TO_BLOCKCHAIN_FAILED,
            (Common) EventsStore.common(),
            (User) EventsStore.user(),
            errorReason,
