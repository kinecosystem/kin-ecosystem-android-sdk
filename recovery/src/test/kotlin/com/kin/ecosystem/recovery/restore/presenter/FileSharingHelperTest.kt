...
class FileSharingHelperTest {
    ...
    fun `extract uri from result, result code is RESULT_CANCELED return cancel `() {
        val requestFileResult = fileSharingHelper.extractUriFromActivityResult(REQUEST_CODE_IMAGE, RESULT_CANCELED, null)
        requestFileResult.apply {
    ...
    fun `extract uri from result, result code is RESULT_OK return ok with correct data `() {
        ...
        val requestFileResult = fileSharingHelper.extractUriFromActivityResult(REQUEST_CODE_IMAGE, RESULT_OK, data)
        requestFileResult.apply {
